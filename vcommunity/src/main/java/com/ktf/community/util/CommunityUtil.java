...
public class CommunityUtil {
    ...
    public static String md5(String key) {
        if (StringUtils.isBlank(key)) {   //  判空，用的lang3这个工具包
            return null;
        }
        return DigestUtils.md5DigestAsHex(key.getBytes());  // spring中的工具类
    }
    ...
    public static String getJSONString(int code, String msg, Map<String, Object> map) {
        JSONObject json = new JSONObject();  //  alibaba 的 fastjson 做的
        json.put("code", code);
        json.put("msg", msg);
        if (map != null) {
    ...
    public static void main(String[] args) {
        ...
        map.put("name", "Jack");
        map.put("age", 18);
        //  {"msg":"OK","code":0,"name":"Jack","age":18}   与我们想要的是一样的
